...
2. Delete the branch only when that cleanup is requested or already
   part of the chosen PR flow.
3. Summarize any follow-up items, release notes, or residual risks
