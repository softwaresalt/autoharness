...
* **Scope guardrails**: This migration path is for installed target workspaces only. It must never modify this repository's own root startup scripts, and it must not resurrect any out-of-scope Plan 3 remote-UI work.
