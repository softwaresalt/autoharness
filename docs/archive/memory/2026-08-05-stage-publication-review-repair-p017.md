...
1. **F3 DAG ready-set semantics.** Finding 3 ("P2 DAG ready-set") above, `checkpoint-20260806-062506.json`,
   ...
   `docs/archive/memory/2026-08-06-stage-publication-review-p2-per-task-allowed-state.md`, but was never propagated
