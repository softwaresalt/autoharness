...
shipment_id: 179-S
latest_attempt: 3
latest_attempt_artifact: docs/reviews/review-history/2026-09-17-single-governing-plan-contract-plan-review-attempt-03.md
verdict: PASS
decision: PASS
p0_open: 0
p1_open: 0
...
| Plan revision | 3 |
| Latest attempt | **03** |
| Authoritative artifact | `docs/reviews/review-history/2026-09-17-single-governing-plan-contract-plan-review-attempt-03.md` |
| Verdict | **PASS** |
| P0 open | 0 |
| P1 open | 0 |
| Plan hardening (P-006) | complete, persisted at `## Plan Hardening Record (P-006)` |
| Feature | `171-F` (10 tasks) |
| Shipment | `179-S` |

**What attempt 03 changed:** Scope reduced to the minimum demonstrated contract; budgets, auto-compaction, harvest rewiring and migration deferred as traceable Stage work; high-complexity tasks split.
...
| 03 | `2026-09-17-single-governing-plan-contract-plan-review-attempt-03.md` | 3 | conforming | PASS | **authoritative** |
