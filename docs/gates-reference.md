...
* [DAG Readiness Gate Reference](dag-readiness-gate.md) — the read-only `autoharness gate dag-readiness` ready-set/critical-path/downstream-dependents report over the same shipment-blocks DAG, and its permanent no-scheduler NON-GOAL
